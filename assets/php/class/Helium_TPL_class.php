...
class tpl{
	...
	# renderX
	###########################
	# render a template X times.
	public function renderX($tpl=null,$nb=null,$replacement=null){
		$data=$this->getVar($replacement);
		...
		for ($i=0;$i<$nb;$i++){
			$temp_data=$data;
			$temp_data[TPL_CHAR.'key']=$tpl.$i.uniqid(true);
			$complete.=$this->render($tpl,$temp_data);
		}
		return $complete;
	}
	...
	public function setContext(&$context=null){			
		...
		$this->locale=tools::getClassInstance($context,'language');
