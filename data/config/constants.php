...
################################
	...
	define('TPL_CHAR','#'); # this char will be putted at start of the keys in the replacement arrays ( ['replacethis'=>'bythat'] will become ['#replacethis'=>'bythat']) to avoid unwanted replacements
